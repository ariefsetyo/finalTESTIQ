...
?>
		...
		<div class="container_12">
            ...
            <div class="grid_12">
                ...
                <!-- Example table -->
                <div class="module">
                	<h2><span>Tabel Kontak Pesan</span></h2>
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    ...
                                    <th style="width:7%">Subjek</th>
                                    <th style="width:7%">Isi Pesan</th>
                            ...
                            <tbody>
								...
								foreach($res as $data){  	
									...
									<td>'.$data['tgl_psn'].'</td>
									<td>
										<a href="?module=kontak&act=hapus&id='.$data['id'].'" onclick="return checkMe()"><img src="bin.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/pencil.gif" width="16" height="16" alt="hapus" /></a>
                                    </td>
									</tr>';
									$no = $no+1;}
								?>
